  ...
  <div class="modal-content">
      ...
      <div class="modal-body">
          <form class="form col-md-12 center-block">
            ...
            <div class="form-group">
              <button class="btn btn-success btn-lg btn-block"><a href="user2.html">Sign In</button></a>
			  <div class="text-center">
								<a><h1>or</h1></a>
				</div>
              <button class="btn btn-success btn-lg btn-block"><a href="register.html">Sign Up</a></button>
            </div>
          </form>
      </div>
