...
<div class="col-md-3 col-md-offset-3">
	<FONT COLOR = White><H1><B><U><center>กรุงเทพมหานคร</center></H1></FONT>
  <FONT COLOR = White><H3><U><center>รายชื่อโรงแรม :</center></H3></FONT> <?php

  for($i =0;$i<count($Hotel);$i++){
    $hotelname = $Hotel[$i]->name;
    $idhotel = $Hotel[$i]->id;
    echo "<a href='/hotel?ID=$idhotel'><FONT COLOR = White>";
    echo "<p align=\"center\">$hotelname</p>";
